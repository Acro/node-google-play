 ...
 * @return {type}
 */
var GooglePlay = (function GooglePlay(username, password, androidId, proxyAgent, useCache, debug, requestsDefaultParams) {
  // default for args:
  ...
  if(requestsDefaultParams) {
    request = Promise.promisifyAll(require('request').defaults(requestsDefaultParams), { multiArgs: true});
  }
