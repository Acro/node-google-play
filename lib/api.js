...
var GooglePlay = (function GooglePlay(username, password, androidId, useCache, _debug, requestsDefaultParams) {
  ...
  var USER_AGENT = "Android-Finsky/6.4.12.C-all%20%5B0%5D%202744941 (api=3,versionCode=80641200,sdk=17,device=AndyOSX,hardware=andy,product=AndyOSX,platformVersionRelease=4.2.2,model=AndyOSX,buildId=JDQ39E,isWideScreen=1)"
